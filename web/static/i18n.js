...
const DICT = {
  ja: {
    ...
    "viewport.range_enter": "指定範囲撮影",
    "viewport.range_exit": "撮影終了",
    "viewport.capture": "撮影",
    "viewport.range_reset": "リセット",
    "viewport.bg_color": "背景色指定",
    "input.lhand_drop": "Left hand image",
    "input.rhand_drop": "Right hand image",
    "input.flip_lr": "左右反転",
    ...
    "tooltip.range_enter": "クリックで指定範囲撮影モードに入る／撮影終了で抜ける",
    "tooltip.capture_shot": "現在の範囲指定でレンダリング画像を PNG 保存",
    "tooltip.range_reset": "範囲指定をリセットしてビュー全体を撮影対象に戻す",
    "tooltip.bg_color": "撮影 PNG の背景色を指定（既定は白）",
    "tooltip.hand_flip": "読み込んだ手の画像を左右反転する",
  ...
  en: {
    ...
    "viewport.range_enter": "Range capture",
    "viewport.range_exit": "Finish capture",
    "viewport.capture": "Capture",
    "viewport.range_reset": "Reset",
    "viewport.bg_color": "Background color",
    "input.lhand_drop": "Left hand image",
    "input.rhand_drop": "Right hand image",
    "input.flip_lr": "Mirror",
    "status.init": "initializing…",
    ...
    "tooltip.range_enter": "Click to enter / leave range-capture mode",
    "tooltip.capture_shot": "Save the rendered image as PNG (cropped to the selected range)",
    "tooltip.range_reset": "Clear the saved range and capture the full view",
    "tooltip.bg_color": "Background color used for the saved PNG (default: white)",
    "tooltip.hand_flip": "Mirror the loaded hand image in place",
